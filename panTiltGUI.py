...
up_btn = Button(btn_Frame, bg="#ADD8E6", width=0, height=0, image=new_up, command=motor.elevation_clockwise())
up_btn.grid(row=0, column=1)

down_btn = Button(btn_Frame, bg="#ADD8E6", width=0, height=0, image=new_down, command=motor.elevation_anti_clockwise())
down_btn.grid(row=2, column=1)

left_btn = Button(btn_Frame, bg="#ADD8E6", width=0, height=0, image=new_left, command=motor.azimuth_anti_clockwise())
left_btn.grid(row=1, column=0)

right_btn = Button(btn_Frame, bg="#ADD8E6", width=0, height=0, image=new_right, command=motor.azimuth_clockwise())
